...
void Synthetics::CreateObjects() {
  ...
  GameObject* obj1 = CreateGameObject(new btBoxShape(btVector3(1, 1, 1)), 1, btVector3(0.6f, 0.f, 0.6f), btVector3(5.0f, 4.0f, -5.0f));
  GameObject* obj2 = CreateGameObject(new btBoxShape(btVector3(1, 1, 1)), 1, btVector3(0.6f, 0.f, 0.6f), btVector3(10.0f, 4.0f, -5.0f));
  btTransform pivot1;
  pivot1.setIdentity();
